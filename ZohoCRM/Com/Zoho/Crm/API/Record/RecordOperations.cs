...
namespace Com.Zoho.Crm.API.Record
{
	...
	public class RecordOperations
	{
		...
		/// <returns>Instance of APIResponse<ActionHandler></returns>
		public APIResponse<ActionHandler> ConvertLead(long? id, ConvertBodyWrapper request)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();

			string apiPath="";

			apiPath=string.Concat(apiPath, "/crm/v5/Leads/");
		...
		public APIResponse<FileHandler> UploadPhoto(long? id, string moduleAPIName, FileBodyWrapper request, ParameterMap paramInstance)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
		...
		/// <param name="moduleAPIName">string</param>
		/// <returns>Instance of APIResponse<ResponseHandler></returns>
		public APIResponse<ResponseHandler> LeadConversionOptions(long? id, string moduleAPIName)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
