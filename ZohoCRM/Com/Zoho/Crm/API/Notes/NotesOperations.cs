...
namespace Com.Zoho.Crm.API.Notes
{
	...
	public class NotesOperations
	{
		...
		public APIResponse<ResponseHandler> GetNotes(ParameterMap paramInstance, HeaderMap headerInstance)
		{
			...
			apiPath=string.Concat(apiPath, "/crm/v5/Notes");
		...
		{
			public static readonly Header<string> IF_MODIFIED_SINCE=new Header<string>("If-Modified-Since", "com.zoho.crm.api.Notes.GetNotesHeader");
		}
		...
		{
			public static readonly Header<string> IF_MODIFIED_SINCE=new Header<string>("If-Modified-Since", "com.zoho.crm.api.Notes.GetNoteHeader");
		}
