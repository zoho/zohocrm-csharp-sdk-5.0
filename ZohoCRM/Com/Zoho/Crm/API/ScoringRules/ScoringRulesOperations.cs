...
namespace Com.Zoho.Crm.API.ScoringRules
{
	...
	public class ScoringRulesOperations
	{
		...
		public APIResponse<ActionHandler> CreateScoringRules(BodyWrapper request)
		{
			...
			apiPath=string.Concat(apiPath, "/crm/v5/settings/automation/scoring_rules");
		...
		public static class GetScoringRulesParam
		{
			...
			public static readonly Param<bool?> ACTIVE=new Param<bool?>("active", "com.zoho.crm.api.ScoringRules.GetScoringRulesParam");
		...
		{
			public static readonly Param<long?> IDS=new Param<long?>("ids", "com.zoho.crm.api.ScoringRules.DeleteScoringRulesParam");
		}
		...
		public static class GetScoringRuleParam
		{
			...
			public static readonly Param<bool?> ACTIVE=new Param<bool?>("active", "com.zoho.crm.api.ScoringRules.GetScoringRuleParam");
