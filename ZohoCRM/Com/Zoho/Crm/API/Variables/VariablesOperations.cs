...
namespace Com.Zoho.Crm.API.Variables
{
	...
	public class VariablesOperations
	{
		...
		public APIResponse<ResponseHandler> GetVariables(ParameterMap paramInstance)
		{
			...
			apiPath=string.Concat(apiPath, "/crm/v5/settings/variables");
		...
		/// <summary>The method to createvariable </summary>
		/// <param name="request">Instance of BodyWrapper</param>
		/// <returns>Instance of APIResponse<ActionHandler></returns>
		public APIResponse<ActionHandler> Createvariable(BodyWrapper request)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
