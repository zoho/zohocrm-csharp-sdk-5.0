...
namespace Com.Zoho.Crm.API.Modules
{
	...
	public class ModuleFields : Fields.Fields , Model
	{
		...
		private ModuleFieldLookup lookup;
		...
		public ModuleFieldLookup Lookup
		{
			/// <summary>The method to get the lookup</summary>
			/// <returns>Instance of ModuleFieldLookup</returns>
			get
			{
				return  this.lookup;
			...
			/// <param name="lookup">Instance of ModuleFieldLookup</param>
			set
			{
				 this.lookup=value;
