...
namespace Com.Zoho.Crm.API.Territories
{
	...
	public class TerritoriesOperations
	{
		...
		public APIResponse<ResponseHandler> GetTerritories(ParameterMap paramInstance)
		{
			...
			apiPath=string.Concat(apiPath, "/crm/v5/settings/territories");
		...
		public APIResponse<ResponseHandler> GetAssociatedUserCount()
		{
			...
			apiPath=string.Concat(apiPath, "/crm/v5/settings/territories/actions/associated_users_count");
		...
		public APIResponse<ActionHandler> TransferAndDeleteTerritories(TransferBodyWrapper request)
		{
			...
			apiPath=string.Concat(apiPath, "/crm/v5/settings/territories/actions/transfer_and_delete");
		...
		{
			public static readonly Param<long?> IDS=new Param<long?>("ids", "com.zoho.crm.api.Territories.DeleteTerritoriesParam");
