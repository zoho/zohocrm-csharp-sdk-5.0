...
namespace Com.Zoho.API.Authenticator
{
    ...
    public class OAuthToken : IToken
    {
        ...
        private OAuthToken RefreshAccessToken(OAuthToken oauthToken, ITokenStore store, string url)
        {
            try
            {
        ...
        private OAuthToken GenerateAccessToken(OAuthToken oauthToken, ITokenStore store, string url)
        {
            try
            {
                Dictionary<string, string> requestParams = new Dictionary<string, string>
