...
namespace Com.Zoho.Crm.API.Profiles
{
	...
	public class ProfilesOperations
	{
		...
		public APIResponse<ResponseHandler> GetProfiles(ParameterMap paramInstance)
		{
			...
			apiPath=string.Concat(apiPath, "/crm/v5/settings/profiles");
		...
		/// <param name="request">Instance of ProfileWrapper</param>
		/// <returns>Instance of APIResponse<ActionHandler></returns>
		public APIResponse<ActionHandler> CloneProfiles(long? id, ProfileWrapper request)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
		...
		/// <param name="request">Instance of ProfileWrapper</param>
		/// <returns>Instance of APIResponse<ActionHandler></returns>
		public APIResponse<ActionHandler> UpdateProfile(long? id, ProfileWrapper request)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
