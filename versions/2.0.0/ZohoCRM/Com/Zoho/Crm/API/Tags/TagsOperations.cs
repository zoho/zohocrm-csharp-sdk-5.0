...
namespace Com.Zoho.Crm.API.Tags
{
	...
	public class TagsOperations
	{
		...
		public APIResponse<ResponseHandler> GetTags(ParameterMap paramInstance)
		{
			...
			apiPath=string.Concat(apiPath, "/crm/v5/settings/tags");
		...
		/// <param name="paramInstance">Instance of ParameterMap</param>
		/// <returns>Instance of APIResponse<ActionHandler></returns>
		public APIResponse<ActionHandler> UpdateTag(string id, BodyWrapper request, ParameterMap paramInstance)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
		...
		public APIResponse<RecordActionHandler> AddTags(long? recordId, string module, NewTagRequestWrapper request, ParameterMap paramInstance)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
		...
		/// <returns>Instance of APIResponse<RecordActionHandler></returns>
		public APIResponse<RecordActionHandler> RemoveTags(long? recordId, string module, ExistingTagRequestWrapper request)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
		...
		/// <param name="paramInstance">Instance of ParameterMap</param>
		/// <returns>Instance of APIResponse<RecordActionHandler></returns>
		public APIResponse<RecordActionHandler> AddTagsToMultipleRecords(string module, NewTagRequestWrapper request, ParameterMap paramInstance)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
		...
		/// <param name="paramInstance">Instance of ParameterMap</param>
		/// <returns>Instance of APIResponse<RecordActionHandler></returns>
		public APIResponse<RecordActionHandler> RemoveTagsFromMultipleRecords(string module, ExistingTagRequestWrapper request, ParameterMap paramInstance)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
