...
namespace Com.Zoho.Crm.API.UsersUnavailability
{
	...
	public class UsersUnavailabilityOperations
	{
		...
		public APIResponse<ActionHandler> CreateUsersUnavailability(BodyWrapper request)
		{
			...
			apiPath=string.Concat(apiPath, "/crm/v5/settings/users_unavailability");
		...
		/// <summary>The method to update users unavailabilites</summary>
		/// <param name="request">Instance of BodyWrapper</param>
		/// <returns>Instance of APIResponse<ActionHandler></returns>
		public APIResponse<ActionHandler> UpdateUsersUnavailabilites(BodyWrapper request)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
		...
		/// <summary>The method to delete user unavailability hour</summary>
		/// <param name="id">string</param>
		/// <returns>Instance of APIResponse<ActionHandler></returns>
		public APIResponse<ActionHandler> DeleteUserUnavailabilityHour(string id)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
