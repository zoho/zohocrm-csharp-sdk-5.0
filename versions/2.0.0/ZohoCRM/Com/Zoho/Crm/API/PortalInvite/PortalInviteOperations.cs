...
namespace Com.Zoho.Crm.API.PortalInvite
{
	...
	public class PortalInviteOperations
	{
		...
		public static class InviteUsersParam
		{
			...
			public static readonly Param<string> TYPE=new Param<string>("type", "com.zoho.crm.api.PortalInvite.InviteUsersParam");
			public static readonly Param<string> LANGUAGE=new Param<string>("language", "com.zoho.crm.api.PortalInvite.InviteUsersParam");
		}
