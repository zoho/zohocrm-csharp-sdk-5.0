...
namespace Com.Zoho.Crm.API.RecordLocking
{
	...
	public class ErrorWrapper : Model, ErrorHandler
	{
		private List<ActionResponses> recordLockingConfigurations;
		private Dictionary<string, int?> keyModified=new Dictionary<string, int?>();

		public List<ActionResponses> RecordLockingConfigurations
		{
			/// <summary>The method to get the recordLockingConfigurations</summary>
			/// <returns>Instance of List<ActionResponses></returns>
			get
			{
			...
			/// <param name="recordLockingConfigurations">Instance of List<ActionResponses></param>
			set
			{
