...
namespace Com.Zoho.Crm.API.Layouts
{
	...
	public class SectionField : Fields.Fields , Model
	{
		...
		private SectionSubformField subform;
		...
		public Choice<int?> Length
		{
			...
			/// <param name="length">Instance of Choice<int?></param>
			set
			{
				 this.length=value;
		...
		public SectionSubformField Subform
		{
			/// <summary>The method to get the subform</summary>
			/// <returns>Instance of SectionSubformField</returns>
			get
			{
				return  this.subform;
			...
			/// <param name="subform">Instance of SectionSubformField</param>
			set
			{
				 this.subform=value;
