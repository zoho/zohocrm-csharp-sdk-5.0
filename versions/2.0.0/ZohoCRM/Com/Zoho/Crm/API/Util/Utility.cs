...
namespace Com.Zoho.Crm.API.Util
{
    ...
    public class Utility
    {
	    ...
	    public static object GetFieldsDetails(string moduleAPIName)
	    {
		    ...
		    if(response != null)
		    {
			    ...
			    if(response.IsExpected)
			    {
				    ...
				    if (responseHandler is Fields.BodyWrapper)
				    {
						Fields.BodyWrapper responseWrapper = (Fields.BodyWrapper) responseHandler;
        ...
        {
            string apiType = field.DataType.Value;
            string keyName = field.APIName;
            ...
            else if(apiType.Equals(Constants.FORMULA, StringComparison.OrdinalIgnoreCase))
            {
                ...
                {
                    string returnType = field.Formula.ReturnType.Value;
