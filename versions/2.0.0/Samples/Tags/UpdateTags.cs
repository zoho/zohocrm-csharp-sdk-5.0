...
using UpdateTagsParam = Com.Zoho.Crm.API.Tags.TagsOperations.UpdateTagsParam;
...
namespace Samples.Tags
{
	...
	{
		public static void UpdateTags_1(string moduleAPIName)
		{
