...
namespace Samples.Profile
{
	...
	{
		public static void CloneProfiles_1(long profileId)
		{
			...
			profile.Name = "Java Beta SDK";
			profile.Description = "V4 SDK";
		...
		public static void Call()
		{
			try
			{
				...
				long profileId = 3477061026011;
                CloneProfiles_1(profileId);
			}
			catch (Exception e)
			{
