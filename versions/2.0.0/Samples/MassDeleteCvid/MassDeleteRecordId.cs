...
using RecordIdBodyWrapper = Com.Zoho.Crm.API.MassDeleteCvid.RecordIdBodyWrapper;
...
namespace Samples.Massdeletecvid
{
	...
	{
		public static void MassDeleteRecordId_1(string moduleAPIName)
		{
			...
			bodyWrapper.Ids = new List<long?>() { 347706120037002, 347706119828001 } ;
		...
		public static void Call()
		{
			try
			{
                ...
                MassDeleteRecordId_1(moduleAPIName);
			}
			catch (Exception e)
			{
