...
namespace Samples.Usersterritories
{
	...
	{
		public static void ValidateBeforeTransfer_1(long userId, long territoryId)
		{
			UsersTerritoriesOperations usersTerritoriesOperations = new UsersTerritoriesOperations();
			APIResponse<ValidationHandler> response = usersTerritoriesOperations.ValidateBeforeTransfer(territoryId, userId);
			if (response != null)
			{
		...
		public static void Call()
		{
			try
			{
                ...
                ValidateBeforeTransfer_1(userId, territoryId);
			}
			catch (Exception e)
			{
