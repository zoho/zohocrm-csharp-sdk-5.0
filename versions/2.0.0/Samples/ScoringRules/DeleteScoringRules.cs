...
using DeleteScoringRulesParam = Com.Zoho.Crm.API.ScoringRules.ScoringRulesOperations.DeleteScoringRulesParam;
...
namespace Samples.Scoringrules
{
	...
	{
		public static void DeleteScoringRules_1()
		{
			ScoringRulesOperations scoringRulesOperations = new ScoringRulesOperations();
			ParameterMap paramInstance = new ParameterMap();
			paramInstance.Add (DeleteScoringRulesParam.IDS, "34770425001");
