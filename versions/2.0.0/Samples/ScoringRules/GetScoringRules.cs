...
using GetScoringRulesParam = Com.Zoho.Crm.API.ScoringRules.ScoringRulesOperations.GetScoringRulesParam;
...
namespace Samples.Scoringrules
{
	...
	{
		public static void GetScoringRules_1()
		{
				...
				if (response.IsExpected)
				{
					...
					if (responseHandler is ResponseWrapper)
					{
						...
						foreach (Com.Zoho.Crm.API.ScoringRules.ScoringRule scoringRule in scoringRules)
						{
							...
							Com.Zoho.Crm.API.Modules.Modules module =  scoringRule.Module;
							if (module != null)
							{
								Console.WriteLine ("ScoringRule Module ID: " + module.Id);
								Console.WriteLine ("ScoringRule Module APIName: " + module.APIName);
							}
