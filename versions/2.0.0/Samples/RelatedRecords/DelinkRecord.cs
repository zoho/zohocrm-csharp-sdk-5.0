...
namespace Samples.Relatedrecords
{
	...
	{
		public static void DelinkRecord_1(string moduleAPIName, long recordId, string relatedListAPIName, long relatedListId)
		{
		...
		public static void Call()
		{
			try
			{
				...
				long relatedListId = 34770614994115l;
                    DelinkRecord_1(moduleAPIName, recordId, relatedListAPIName, relatedListId);
			}
			catch (Exception e)
			{
