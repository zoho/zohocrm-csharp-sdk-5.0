...
using GetRelatedRecordsParam = Com.Zoho.Crm.API.RelatedRecords.RelatedRecordsOperations.GetRelatedRecordsParam;
...
namespace Samples.Relatedrecords
{
	...
	{
		public static void GetRelatedRecords_1(string moduleAPIName, long recordId, string relatedListAPIName)
		{
	...
	//		headerInstance.Add (GetRelatedRecordsHeader.IF_MODIFIED_SINCE, startdatetime);
		...
		public static void Call()
		{
			try
			{
                ...
                GetRelatedRecords_1(moduleAPIName, recordId, relatedListAPIName);
			}
			catch (Exception e)
			{
