...
namespace Samples.Relatedrecords
{
	...
	{
		public static void DeleteRelatedRecordUsingExternalId_1(string moduleAPIName, string externalValue, string relatedListAPIName, string externalFieldValue)
		{
		...
		public static void Call()
		{
			try
			{
                ...
                DeleteRelatedRecordUsingExternalId_1(moduleAPIName, externalValue, relatedListAPIName, externalFieldValue);
			}
			catch (Exception e)
			{
