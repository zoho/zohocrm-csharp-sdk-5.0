...
{
	public class UpdateLockReasonOfARecord
	{
		public static void UpdateLockReasonOfARecord_1(long recordId, string moduleName, long lockId)
		{
			...
			APIResponse<ActionHandler> response = recordLockingOperations.UpdateLockReasonOfARecord(lockId, recordId, moduleName, bodyWrapper);
			if (response != null)
			{
		...
		public static void Call()
		{
			try
			{
                ...
                UpdateLockReasonOfARecord_1(recordId, moduleAPIName, lockId);
			}
			catch (Exception e)
			{
