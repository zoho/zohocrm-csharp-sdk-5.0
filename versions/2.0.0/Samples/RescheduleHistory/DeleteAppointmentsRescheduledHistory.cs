...
{
	public class DeleteAppointmentsRescheduledHistory
	{
		public static void DeleteAppointmentsRescheduledHistory_1(long id)
		{
			RescheduleHistoryOperations rescheduleHistoryOperations = new RescheduleHistoryOperations();
			APIResponse<ActionHandler> response = rescheduleHistoryOperations.DeleteAppointmentsRescheduledHistory(id);
			if (response != null)
			{
		...
		public static void Call()
		{
			try
			{
                ...
                DeleteAppointmentsRescheduledHistory_1(id);
			}
			catch (Exception e)
			{
