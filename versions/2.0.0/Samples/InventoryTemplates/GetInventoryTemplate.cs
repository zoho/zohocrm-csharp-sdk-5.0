...
namespace Samples.Inventorytemplates
{
	...
	{
		public static void GetInventoryTemplate_1(long InventoryTemplateID)
		{
				...
				if (response.IsExpected)
				{
					...
					if (responseHandler is ResponseWrapper)
					{
						...
						foreach (InventoryTemplate inventoryTemplate in inventoryTemplates)
						{
							...
							Console.WriteLine ("InventoryTemplate : " + inventoryTemplate.EditorMode);
		...
		public static void Call()
		{
			try
			{
                ...
                GetInventoryTemplate_1(InventoryTemplateID);
			}
			catch (Exception e)
			{
