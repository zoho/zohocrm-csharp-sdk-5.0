...
namespace Samples.Variables
{
	...
	{
		public static void UpdateVariableByAPIName_1(string variableName)
		{
            ...
            paramInstance.Add(GetVariableByIDParam.GROUP, "General");
            APIResponse<ActionHandler> response = variablesOperations.UpdateVariableByApiname(variableName, request, paramInstance);
			if (response != null)
			{
		...
		public static void Call()
		{
			try
			{
                ...
                UpdateVariableByAPIName_1(variableName);
			}
			catch (Exception e)
			{
