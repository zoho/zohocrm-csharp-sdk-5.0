...
using Info = Com.Zoho.Crm.API.Users.Info;
...
using GetUsersParam = Com.Zoho.Crm.API.Users.UsersOperations.GetUsersParam;
				...
				if (response.IsExpected)
				{
					...
					if (responseHandler is ResponseWrapper)
					{
						...
						foreach (Com.Zoho.Crm.API.Users.Users user in users)
						{
							...
							Console.WriteLine ("User Status: " + user.Category);
						}
