...
namespace Samples.Users
{
	...
	{
		public static void CreateUser_1()
		{
			...
			user1.Email = "csharpsdk13@zoho.com";
            Com.Zoho.Crm.API.Users.Profile profile = new Com.Zoho.Crm.API.Users.Profile();
			profile.Id = 34771;
			user1.Profile = profile;
			user1.LastName = "TestUser LastName";
			...
			Com.Zoho.Crm.API.ShiftHours.ShiftHours shifthour =  new Com.Zoho.Crm.API.ShiftHours.ShiftHours();
			shifthour.Id = 347706452003;
