...
using SearchRecordsParam = Com.Zoho.Crm.API.Record.RecordOperations.SearchRecordsParam;
...
namespace Samples.Record
{
	...
	{
		public static void SearchRecords_1(string moduleAPIName)
		{
