...
namespace Samples.Record
{
	public class UpdateRecord
	{
		public static void UpdateRecord_1(string moduleAPIName, long recordId)
		{
			...
			record1.AddKeyValue("Multiselect", new List<Choice<string>>() {new Choice<string>("Option 1") });
			...
			deletesubform.Id = 34770619314010;	
	...
	//		headerInstance.Add (UpdateRecordHeader.X_EXTERNAL, "Leads.External");
		...
		public static void Call()
		{
			try
			{
                ...
                UpdateRecord_1(moduleAPIName, recordId);
			}
			catch (Exception e)
			{
