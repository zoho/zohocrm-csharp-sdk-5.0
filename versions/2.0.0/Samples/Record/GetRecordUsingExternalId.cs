...
using Layouts = Com.Zoho.Crm.API.Layouts.Layouts;
...
namespace Samples.Record
{
	...
	{
		public static void GetRecordUsingExternalId_1(string moduleAPIName, string externalFieldValue, string destinationFolder)
		{
		...
		public static void Call()
		{
			try
			{
                ...
                GetRecordUsingExternalId_1(moduleAPIName, externalFieldValue, destinationFolder);
			}
			catch (Exception e)
			{
