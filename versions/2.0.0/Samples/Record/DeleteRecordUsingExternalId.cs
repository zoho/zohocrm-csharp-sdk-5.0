...
using DeleteRecordHeader = Com.Zoho.Crm.API.Record.RecordOperations.DeleteRecordHeader;
using DeleteRecordParam = Com.Zoho.Crm.API.Record.RecordOperations.DeleteRecordParam;
	...
	public class DeleteRecordUsingExternalId
	{
		...
		public static void Call()
		{
			try
			{
                ...
                DeleteRecordUsingExternalId_1(moduleAPIName, externalFieldValue);
			}
			catch (Exception e)
			{
