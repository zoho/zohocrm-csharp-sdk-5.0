...
namespace Samples.Dealcontactroles
{
	...
	{
		public static void AddContactRoleToDeal_1(long contactId, long dealId)
		{
			...
			contactRole.Id = 347706119438003;
			//contactRole.Name = "contactRole1";
		...
		public static void Call()
		{
			try
			{
                ...
                AddContactRoleToDeal_1(contactId, dealId);
			}
			catch (Exception e)
			{
