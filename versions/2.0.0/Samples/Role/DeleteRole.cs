...
using DeleteRoleParam = Com.Zoho.Crm.API.Roles.RolesOperations.DeleteRoleParam;
...
namespace Samples.Role
{
	...
	{
		public static void DeleteRole_1(long roleId)
		{
			RolesOperations rolesOperations = new RolesOperations();
			ParameterMap paramInstance = new ParameterMap();
			paramInstance.Add (DeleteRoleParam.TRANSFER_TO_ID, 347706002);
