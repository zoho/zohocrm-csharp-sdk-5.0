...
namespace Com.Zoho.Crm.API.Util
{
    ...
    public static class Constants
    {
        ...
        public static readonly string DATATYPECONVERTER = "Com.Zoho.Crm.API.Util.DataTypeConverter`1[[$type]], ZOHOCRMSDK-5.0";
        public static readonly string CHOICE = "Com.Zoho.Crm.API.Util.Choice`1[[$type]], ZOHOCRMSDK-5.0";
        ...
        public static readonly string RECORD_TYPE = "Com.Zoho.Crm.API.Record.Record, ZOHOCRMSDK-5.0";
        ...
        public static readonly List<string> SET_CONTENT_TYPE_HEADER = new List<string> { "/crm/bulk/v5/read", "/crm/bulk/v5/write" };
