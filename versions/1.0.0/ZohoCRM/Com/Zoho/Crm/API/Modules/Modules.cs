...
namespace Com.Zoho.Crm.API.Modules
{
	...
	public class Modules : Model
	{
		...
		private List<Layouts.Layouts> layouts;
		private List<ModuleFields> fields;
		private CustomViews.CustomView customView;
		private bool? ziaView;
		private List<Fields.MinifiedField> defaultMappingFields;
		private string status;
		private List<Argument> arguments32;
		...
		public List<Layouts.Layouts> Layouts
		{
		...
		public CustomViews.CustomView CustomView
		{
		...
		public List<Argument> Arguments32
		{
			/// <summary>The method to get the arguments32</summary>
			/// <returns>Instance of List<Argument></returns>
			get
			{
			...
			/// <summary>The method to set the value to arguments32</summary>
			/// <param name="arguments32">Instance of List<Argument></param>
			set
			{
				 this.arguments32=value;
