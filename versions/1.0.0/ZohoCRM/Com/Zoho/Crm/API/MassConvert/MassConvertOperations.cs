...
namespace Com.Zoho.Crm.API.MassConvert
{
	...
	public class MassConvertOperations
	{
		...
		/// <param name="request">Instance of Convert</param>
		/// <returns>Instance of APIResponse<ActionResponse></returns>
		public APIResponse<ActionResponse> MassConvert(Convert request)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();

			string apiPath="";

			apiPath=string.Concat(apiPath, "/crm/v5/Leads/actions/mass_convert");
