...
namespace Com.Zoho.Crm.API.HipaaCompliance
{
	...
	{
		private ActionHandler hipaaCompliance;
		private Dictionary<string, int?> keyModified=new Dictionary<string, int?>();

		public ActionHandler HipaaCompliance
		{
			/// <summary>The method to get the hipaaCompliance</summary>
			/// <returns>Instance of ActionHandler</returns>
			get
			{
			...
			/// <param name="hipaaCompliance">Instance of ActionHandler</param>
			set
			{
