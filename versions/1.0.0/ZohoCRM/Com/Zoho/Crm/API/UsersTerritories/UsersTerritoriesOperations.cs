...
namespace Com.Zoho.Crm.API.UsersTerritories
{
	...
	public class UsersTerritoriesOperations
	{
		...
		public APIResponse<ResponseHandler> GetTerritoriesOfUser(long? user)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();

			string apiPath="";

			apiPath=string.Concat(apiPath, "/crm/v5/users/");
		...
		public APIResponse<ActionHandler> AssociateTerritoriesToUser(long? user, BodyWrapper request)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
		...
		/// <param name="user">long?</param>
		/// <returns>Instance of APIResponse<ResponseHandler></returns>
		public APIResponse<ResponseHandler> GetTerritoryOfUser(long? territory, long? user)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
		...
		public APIResponse<ValidationHandler> ValidateBeforeTransferForAllTerritories(long? user)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
		...
		/// <param name="user">long?</param>
		/// <returns>Instance of APIResponse<ValidationHandler></returns>
		public APIResponse<ValidationHandler> ValidateBeforeTransfer(long? territory, long? user)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
		...
		public APIResponse<TransferActionHandler> DelinkAndTransferFromAllTerritories(long? user, TransferWrapper request)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
		...
		/// <param name="request">Instance of TransferWrapper</param>
		/// <returns>Instance of APIResponse<TransferActionHandler></returns>
		public APIResponse<TransferActionHandler> DelinkAndTransferFromSpecificTerritory(long? territory, long? user, TransferWrapper request)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
