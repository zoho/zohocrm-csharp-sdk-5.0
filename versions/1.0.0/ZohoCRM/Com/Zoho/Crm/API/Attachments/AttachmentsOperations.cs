...
namespace Com.Zoho.Crm.API.Attachments
{
	...
	{
		/// <summary>The method to create attachment</summary>
		...
		public APIResponse<ActionHandler> CreateAttachment(long? recordId, string module, FileBodyWrapper request)
		{
		...
		public static class GetAttachmentsParam
		{
			...
			public static readonly Param<long?> IDS=new Param<long?>("ids", "com.zoho.crm.api.Attachments.GetAttachmentsParam");
