...
namespace Com.Zoho.Crm.API.Timelines
{
	...
	public class TimelinesOperations
	{
		...
		{
			public static readonly Param<string> INCLUDE_INNER_DETAILS=new Param<string>("include_inner_details", "com.zoho.crm.api.Timelines.GetTimelinesParam");
			public static readonly Param<string> SORT_BY=new Param<string>("sort_by", "com.zoho.crm.api.Timelines.GetTimelinesParam");
			public static readonly Param<string> SORT_ORDER=new Param<string>("sort_order", "com.zoho.crm.api.Timelines.GetTimelinesParam");
			...
			public static readonly Param<string> INCLUDE=new Param<string>("include", "com.zoho.crm.api.Timelines.GetTimelinesParam");
