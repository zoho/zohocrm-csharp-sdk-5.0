...
namespace Com.Zoho.Crm.API.EmailComposeMeta
{
	...
	public class DataMap : Model
	{
		...
		public List<object> RelayDomains
		{
			...
			/// <param name="relayDomains">Instance of List<object></param>
			set
			{
		...
		public DefaultForm DefaultFrom
		{
			/// <summary>The method to get the defaultFrom</summary>
			...
			/// <summary>The method to set the value to defaultFrom</summary>
			/// <param name="defaultFrom">Instance of DefaultForm</param>
			set
			{
				 this.defaultFrom=value;

				 this.keyModified["default_from"] = 1;
