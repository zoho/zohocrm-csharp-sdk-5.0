...
namespace Samples.Territories
{
	...
	{
		public static void CreateTerritories_1()
		{
			...
			reportingTo.Id = 34770051357;
			territory.ReportingTo = reportingTo;
			Manager manager = new Manager();
			manager.Id = 347706173021;
			territory.Manager = manager;
			territories.Add (territory);
			request.Territories = territories;
			APIResponse<ActionHandler> response = territoriesOperations.CreateTerritories(request);
			if (response != null)
			{
