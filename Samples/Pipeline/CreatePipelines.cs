...
namespace Samples.Pipeline
{
	...
	{
		public static void CreatePipelines_1(long LayoutId)
		{
		...
		public static void Call()
		{
			try
			{
				...
				long layoutId = 3477061091023;
                CreatePipelines_1(layoutId);
			}
			catch (Exception e)
			{
