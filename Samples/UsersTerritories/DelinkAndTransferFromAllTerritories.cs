...
namespace Samples.Usersterritories
{
	...
	{
		public static void DelinkAndTransferFromAllTerritories_1(long userId)
		{
			...
			territory.Id = 34771397;
			TransferToUser transferToUser = new TransferToUser();
			transferToUser.Id = 3477024;
			territory.TransferToUser = transferToUser;
			userTerritoryList.Add (territory);
			request.TransferAndDelink = userTerritoryList;
			APIResponse<TransferActionHandler> response = usersTerritoriesOperations.DelinkAndTransferFromAllTerritories(userId, request);
			if (response != null)
			{
		...
		public static void Call()
		{
			try
			{
                ...
                DelinkAndTransferFromAllTerritories_1(userId);
			}
			catch (Exception e)
			{
