...
namespace Samples.Attachments
{
	...
	{
		public static void DeleteAttachment_1(string moduleAPIName, long recordId, long attachmentId)
		{
			AttachmentsOperations attachmentsOperations = new AttachmentsOperations();
			APIResponse<ActionHandler> response = attachmentsOperations.DeleteAttachment(attachmentId, recordId, moduleAPIName);
			if (response != null)
			{
		...
		public static void Call()
		{
			try
			{
                ...
                DeleteAttachment_1(moduleAPIName, recordId, attachmentId);
			}
			catch (Exception e)
			{
