...
using GetVariableByAPINameParam = Com.Zoho.Crm.API.Variables.VariablesOperations.GetVariableByAPINameParam;
...
namespace Samples.Variables
{
	...
	{
		public static void GetVariableForAPIName_1(string variableName)
		{
		...
		public static void Call()
		{
			try
			{
                ...
                GetVariableForAPIName_1(variableName);
			}
			catch (Exception e)
			{
