...
using GetVariableByIDParam = Com.Zoho.Crm.API.Variables.VariablesOperations.GetVariableByIDParam;
...
namespace Samples.Variables
{
	...
	{
		public static void GetVariableById_1(long variableId)
		{
