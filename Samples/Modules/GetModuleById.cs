...
namespace Samples.Modules
{
	...
	{
		public static void GetModuleById_1(long moduleId)
		{
			ModulesOperations moduleOperations = new ModulesOperations();
			APIResponse<ResponseHandler> response = moduleOperations.GetModule(moduleId);
			if (response != null)
			{
		...
		public static void Call()
		{
			try
			{
				...
				long moduleId = 4402480037l;
                GetModuleById_1(moduleId);
			}
			catch (Exception e)
			{
