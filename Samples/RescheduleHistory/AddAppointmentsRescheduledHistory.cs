...
{
	public class AddAppointmentsRescheduledHistory
	{
		public static void AddAppointmentsRescheduledHistory_1()
		{
			...
			request.Data = data;
			APIResponse<ActionHandler> response = rescheduleHistoryOperations.AddAppointmentsRescheduledHistory(request);
			if (response != null)
			{
		...
		public static void Call()
		{
			try
			{
                ...
                AddAppointmentsRescheduledHistory_1();
			}
			catch (Exception e)
			{
