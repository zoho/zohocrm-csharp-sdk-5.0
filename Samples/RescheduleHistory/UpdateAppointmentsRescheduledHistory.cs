...
{
	public class UpdateAppointmentsRescheduledHistory
	{
		public static void UpdateAppointmentsRescheduledHistory_1()
		{
			...
			request.Data = data;
			APIResponse<ActionHandler> response = rescheduleHistoryOperations.UpdateAppointmentsRescheduledHistory(request);
			if (response != null)
			{
		...
		public static void Call()
		{
			try
			{
                ...
                UpdateAppointmentsRescheduledHistory_1();
			}
			catch (Exception e)
			{
