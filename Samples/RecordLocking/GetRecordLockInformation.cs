...
{
	public class GetRecordLockInformation
	{
		public static void GetRecordLockInformation_1(string moduleAPIName, long recordId)
		{
			...
			APIResponse<ResponseHandler> response = recordLockingOperations.GetRecordLockInformation(recordId, moduleAPIName, paramInstance);
			if (response != null)
			{
		...
		public static void Call()
		{
			try
			{
				...
				long recordId = 34770619001l;
                GetRecordLockInformation_1(moduleAPIName, recordId);
			}
			catch (Exception e)
			{
