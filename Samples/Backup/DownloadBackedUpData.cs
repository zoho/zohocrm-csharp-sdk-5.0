...
using FileBodyWrapper = Com.Zoho.Crm.API.Backup.FileBodyWrapper;
...
namespace Samples.Backup
{
	...
	{
		public static void DownloadBackedUpData_1(string downloadUrl, string destinationFolder)
		{
		...
		public static void Call()
		{
			try
			{
                ...
                DownloadBackedUpData_1(downloadUrl, destinationFolder);
			}
			catch (Exception e)
			{
