...
using DeleteRolesParam = Com.Zoho.Crm.API.ContactRoles.ContactRolesOperations.DeleteRolesParam;
...
namespace Samples.Contactroles
{
	...
	{
		public static void DeleteContactRoles_1(List<string> contactRoleIds)
		{
			ContactRolesOperations contactRolesOperations = new ContactRolesOperations();
			ParameterMap paramInstance = new ParameterMap();
            paramInstance.Add(DeleteRolesParam.IDS, string.Join(",", contactRoleIds));
		...
		public static void Call()
		{
			try
			{
				...
				List<string> contactRoleIds = new List<string>() { "34770615208001", "34770615208002" } ;
                DeleteContactRoles_1(contactRoleIds);
			}
			catch (Exception e)
			{
