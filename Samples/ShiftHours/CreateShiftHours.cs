...
namespace Samples.Shifthours
{
	...
	{
		public static void CreateShiftHours_1()
		{
			ShiftHoursOperations shifthoursoperations = new ShiftHoursOperations("673573045");
			...
			shifthours.SameAsEveryday = false;
			List<string> shiftDays = new List<string>();
			shiftDays.Add ("Monday");
			shiftDays.Add ("Tuesday");
			shifthours.ShiftDays = shiftDays;
			// if same_as_everyday is true
			List<string> dailyTiming = new List<string>();
			dailyTiming.Add ("10:00");
			dailyTiming.Add ("19:00");
			shifthours.DailyTiming = dailyTiming;
			// if same_as_everyday is false
			List<ShiftCustomTiming> customTimings = new List<ShiftCustomTiming>();
			ShiftCustomTiming customtiming = new ShiftCustomTiming();
			List<TimeSpan> shiftTiming = new List<TimeSpan>();
			shiftTiming.Add (new TimeSpan(10, 00,00));
			shiftTiming.Add (new TimeSpan(19, 00,00));
			customtiming.ShiftTiming = shiftTiming;
			customtiming.Days = "Monday";
			customTimings.Add (customtiming);
			ShiftCustomTiming customtiming1 = new ShiftCustomTiming();
			List<TimeSpan> shiftTiming1 = new List<TimeSpan>();
			shiftTiming1.Add (new TimeSpan(10, 00,00));
			shiftTiming1.Add (new TimeSpan(18, 00,00));
			customtiming1.ShiftTiming = shiftTiming1;
			customtiming1.Days = "Tuesday";
			customTimings.Add (customtiming1);
			//shifthours.CustomTiming = customTimings;
			...
			// if same_as_everyday is false
			breakhour.SameAsEveryday = false;
			...
			List<string> breakTimings1 = new List<string>();
			breakTimings1.Add ("16:00");
			breakTimings1.Add ("16:15");
			customTimingforBreakHour1.BreakTiming = breakTimings1;
			customTimingforBreakHour1.Days = "Monday";
	...
	//		user.EffectiveFrom = new DateTime(2023, 10, 12).Date;
			...
			holiday.Date = new DateTime(2023, 12, 01).Date;
	//		holiday.Id = 23456L;
			holiday.Name = "Holi10";
	//		holiday.Year = 2023;
