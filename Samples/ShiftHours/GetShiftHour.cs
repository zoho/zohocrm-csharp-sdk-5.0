...
namespace Samples.Shifthours
{
	...
	{
		public static void GetShiftHour_1(long id)
		{
					...
					if (responseObject is ResponseWrapper)
					{
						...
						if (shifthours != null)
						{
							foreach (ShiftHours shifthour in shifthours)
							{
								...
								List<string> dailyTiming = shifthour.DailyTiming;
								if (dailyTiming != null)
								{
									Console.WriteLine ("Daily_timing : ");
									foreach (string dailytiming in dailyTiming)
									{
								...
								if (breakHours != null)
								{
									foreach (BreakHours breakhour in breakHours)
									{
										...
										List<string> dailyTimings = breakhour.DailyTiming;
										...
										if (breakHoursCustomTimings != null)
										{
											foreach (BreakCustomTiming breakHourCustomTiming in breakHoursCustomTimings)
											{
												...
												List<string> breakTimings = breakHourCustomTiming.BreakTiming;
												if (breakTimings != null)
												{
													foreach (string breakTiming in breakTimings)
													{
		...
		public static void Call()
		{
			try
			{
                ...
                GetShiftHour_1(440248001283021);
			}
			catch (Exception e)
			{
