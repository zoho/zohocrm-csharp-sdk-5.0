...
namespace Samples.Scoringrules
{
	...
	{
		public static void UpdateScoringRule_1(long id)
		{
			...
			scoringRule.Name = "Rule 110021";
			scoringRule.Description = "Rule for Module Leads1";
	...
	//		fieldRule.Delete = null;
		...
		public static void Call()
		{
			try
			{
				...
				long id = 347706114966002;
                UpdateScoringRule_1(id);
			}
			catch (Exception e)
			{
