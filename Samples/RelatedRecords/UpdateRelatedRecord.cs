...
namespace Samples.Relatedrecords
{
	...
	{
		public static void UpdateRelatedRecord_1(string moduleAPIName, long recordId, string relatedListAPIName, long relatedListId)
		{
		...
		public static void Call()
		{
			try
			{
                ...
                UpdateRelatedRecord_1(moduleAPIName, recordId, relatedListAPIName, relatedListId);
			}
			catch (Exception e)
			{
