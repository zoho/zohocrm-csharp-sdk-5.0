...
namespace Samples.Relatedrecords
{
	...
	{
		public static void DeleteRelatedRecordsUsingExternalId_1(string moduleAPIName, string externalValue, string relatedListAPIName, List<string> relatedListIds)
		{
		...
		public static void Call()
		{
			try
			{
                ...
                DeleteRelatedRecordsUsingExternalId_1(moduleAPIName, externalValue, relatedListAPIName, relatedListIds);
			}
			catch (Exception e)
			{
