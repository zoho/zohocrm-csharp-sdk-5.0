...
using GetRelatedRecordsHeader = Com.Zoho.Crm.API.RelatedRecords.RelatedRecordsOperations.GetRelatedRecordsHeader;
...
namespace Samples.Relatedrecords
{
	...
	{
		public static void GetRelatedRecordsUsingExternalId_1(string moduleAPIName, string externalValue, string relatedListAPIName)
		{
			...
			paramInstance.Add (GetRelatedRecordsUsingExternalIDParam.PAGE, 1);
			paramInstance.Add (GetRelatedRecordsUsingExternalIDParam.PER_PAGE, 2);
			paramInstance.Add (GetRelatedRecordsUsingExternalIDParam.FIELDS, "Id");
		...
		public static void Call()
		{
			try
			{
                ...
                GetRelatedRecordsUsingExternalId_1(moduleAPIName, externalValue, relatedListAPIName);
			}
			catch (Exception e)
			{
