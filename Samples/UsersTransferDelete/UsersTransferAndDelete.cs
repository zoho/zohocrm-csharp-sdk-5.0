...
{
	public class UsersTransferAndDelete
	{
		public static void UsersTransferAndDelete_1()
		{
			...
			APIResponse<ActionHandler> response = usersTransferDeleteOperations.UsersTransferAndDelete(request);
			if (response != null)
			{
