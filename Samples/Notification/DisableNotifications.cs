...
using DeleteNotificationParam = Com.Zoho.Crm.API.Notifications.NotificationsOperations.DeleteNotificationParam;
...
namespace Samples.Notification
{
	...
	{
		public static void DisableNotifications_1(List<long> channelIds)
		{
			NotificationsOperations notificationOperations = new NotificationsOperations();
			ParameterMap paramInstance = new ParameterMap();
			foreach (long id in channelIds)
			{
				paramInstance.Add (DeleteNotificationParam.CHANNEL_IDS, id);
			}
			APIResponse<ActionHandler> response = notificationOperations.DeleteNotification(paramInstance);
			if (response != null)
			{
		...
		public static void Call()
		{
			try
			{
				...
				List<long> channelIds = new List<long>() {34770615208001l } ;
                DisableNotifications_1(channelIds);
			}
			catch (Exception e)
			{
