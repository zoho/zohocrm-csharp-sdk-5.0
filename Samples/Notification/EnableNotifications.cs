...
namespace Samples.Notification
{
	public class EnableNotifications
	{
		public static void EnableNotifications_1()
		{
			...
			List<Com.Zoho.Crm.API.Notifications.Notification> notifications = new List<Com.Zoho.Crm.API.Notifications.Notification>();
			...
			notification.ChannelExpiry = new DateTimeOffset(new DateTime(2020, 05, 15, 12, 0, 0, DateTimeKind.Local));
			notification.Token = "TOKEN_FOR_VERIFICATION_OF_1068002";
			notification.NotifyUrl = "https://www.zohoapis.com";
			notifications.Add (notification);
			Com.Zoho.Crm.API.Notifications.Notification notification2 =  new Com.Zoho.Crm.API.Notifications.Notification();
			notification2.ChannelId = "106800211";
			notification.NotifyOnRelatedAction = false;
			List<string> events2 = new List<string>();
			events2.Add ("Accounts.all");
			notification2.Events = events2;
			notification2.ChannelExpiry = new DateTimeOffset(new DateTime(2020, 05, 15, 12, 0, 0, DateTimeKind.Local));
