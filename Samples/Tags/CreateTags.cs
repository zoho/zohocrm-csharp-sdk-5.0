...
using CreateTagsParam = Com.Zoho.Crm.API.Tags.TagsOperations.CreateTagsParam;
...
namespace Samples.Tags
{
	...
	{
		public static void CreateTags_1(string moduleAPIName)
		{
