...
using GetEmailsRelatedRecordsParam = Com.Zoho.Crm.API.EmailRelatedRecords.EmailRelatedRecordsOperations.GetEmailsRelatedRecordsParam;
...
namespace Samples.Emailrelatedrecords
{
	...
	{
		public static void GetRelatedEmails_1(string moduleAPIName, long id)
		{
			EmailRelatedRecordsOperations emailTemplatesOperations = new EmailRelatedRecordsOperations(id, moduleAPIName);
			ParameterMap paramInstance = new ParameterMap();
			paramInstance.Add (GetEmailsRelatedRecordsParam.OWNER_ID, 123l);
			paramInstance.Add(new Param<string>("message_id", "string"), "2132");	
		...
		public static void Call()
		{
			try
			{
                ...
                GetRelatedEmails_1(moduleAPIName, Id);
			}
			catch (Exception e)
			{
